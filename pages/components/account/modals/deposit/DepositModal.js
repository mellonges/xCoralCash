...
import { AccountDepositModalObserver } from "@/functions/observers";
...
const DepositModal = () => {
  ...
  const handleCryptoAmountChange = (a) => {
    setCryptoAmount(a);
  };
  ...
  useEffect(() => {
    const subscription = AccountDepositModalObserver.subscribe((data) => {
      ...
      <ModalBody style={{ padding: 0 }}>
        {activeView === 1 ? (
          <DefaultView
            ...
            updateCryptoAmount={handleCryptoAmountChange}
            amount={amount}
