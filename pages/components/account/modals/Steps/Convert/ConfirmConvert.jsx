    ...
    <div className={`${styles.ConfirmSelling}`}>
      ...
      <div className={styles.confirmInfo}>
        ...
        <div
          className={`${styles.row} d-flex justify-content-between align-items-center`}
        >
          <div className={styles.label}>Convert to</div>
          <div className={styles.value}>
            <div className={styles.cardLogo}>
              {selectedWays && selectedWays.paywith ? (
                <img
                  src={getTokenImageUrl(selectedWays.paywith.ticker, "small")}
                  alt={selectedWays.paywith.ticker}
                />
              ) : null}
            </div>
            {selectedWays.paywith.ticker}
        ...
        <div
          className={`${styles.row} d-flex justify-content-between align-items-center`}
        >
          <div className={styles.label}>{selectedWays.token.ticker} spent</div>
          <div className={styles.value}>
            {buyingInformation.fromConversion.quantity}
          </div>
        </div>
        ...
        >
          <div className={styles.label}>
            {selectedWays.paywith.ticker} received
          </div>
          <div className={styles.value}>
            {buyingInformation.intoConversion.quantity}
          </div>
        </div>
        {/* <div
          className={`${styles.row} d-flex justify-content-between align-items-center`}
        >
          <div className={styles.label}>
            Average {selectedWays.token.ticker} sell price
          </div>
          <div className={styles.value}>
            {formatPrice(buyingInformation.fromConversion.avgPrice)}
          </div>
        </div>
        <div
          className={`${styles.row} d-flex justify-content-between align-items-center`}
        >
          <div className={styles.label}>
            Average {selectedWays.paywith.ticker} buy price
          </div>
          <div className={styles.value}>
            {formatPrice(buyingInformation.intoConversion.avgPrice)}
          </div>
        </div> */}
        <div
          className={`${styles.row} d-flex justify-content-between align-items-center`}
        >
          ...
          <div className={styles.value}>
            {formatPrice(buyingInformation.intoConversion.chargeAmount)}
          </div>
        </div>
        ...
        >
          ...
          <div className={styles.value}>
            {formatPrice(buyingInformation.fromConversion.fee)}
          </div>
        </div>
      </div>
      <Button
